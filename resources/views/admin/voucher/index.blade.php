                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 ">
                            <tr>
                                ...
                                <th class="px-4 py-3">Tên voucher</th>
                                <th class="px-4 py-3">Loại</th>
                                <th class="px-4 py-3">Giá trị</th>
                                <th class="px-4 py-3">Giảm tối đa</th>
                        ...
                        <tbody>
                            @forelse ($vouchers as $voucher)
                                <tr class="border-b dark:border-gray-700">
                                    <td class="px-4 py-3 font-bold">{{ $voucher->code }}</td>
                                    <td class="px-4 py-3">{{ $voucher->name }}</td>
                                    <td class="px-4 py-3">
                                        {{ $voucher->type == 'percent' ? 'Giảm %' : 'Giảm tiền' }}
                                    </td>
                                    <td class="px-4 py-3">{{ number_format($voucher->value) }}</td>
                                    <td class="px-4 py-3">
                                        {{ $voucher->max_discount ? number_format($voucher->max_discount) : 'Không giới hạn' }}
                                    </td>
                                    <td class="px-4 py-3">{{ number_format($voucher->min_order_value) }}</td>
                                    <td class="px-4 py-3">{{ $voucher->start_date }}</td>
                                    <td class="px-4 py-3">{{ $voucher->end_date }}</td>
                                    <td class="px-4 py-3">
                                    ...
                                    <td class="px-4 py-3">
                                        ...
                                        @else
                                            <span class="text-red-600 font-medium">Ngưng</span>
                                        @endif
                                    </td>
                                    ...
                                    <td x-data="{ open: false }"  class="relative">
                                        ...
                                        <div x-show="open" @click.outside="open = false"
                                            class="absolute right-[30px] bottom-10  items-center z-100 gap-2 p-2 bg-white rounded-tl-lg rounded-tr-lg rounded-bl-lg shadow-sm">
                                            <!-- Xem -->
                                            <a href="#"
                            ...
                            @empty
                                <tr>
                                    <td colspan="12" class="text-center py-4">Không có voucher nào</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
